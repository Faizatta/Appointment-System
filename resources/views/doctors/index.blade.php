    ...
    <script>
        $(function() {
                    ...
                    },
                    {
                        ...
                        render: function(d, t) {
                            ...
                            if (t === 'display') {
                                ...
                                let img = d.image ? `<img src="${d.image}" alt="Doctor">` :
                    ...
                    },
                    {
                        ...
                        render: function(d) {
                            ...
                            if (Array.isArray(d) && d.length > 0) {
                                return d.map(p => p.name || p.full_name || p).join(', ');
                            }

                            // Single object fallback
                            return d.name || d.full_name || d || 'No Patients';
                        }
                    },
            ...
            $(document).on('click', '.view-doctor', function() {
                ...
                $('#viewDoctorPatients').text(Array.isArray(d.patients) && d.patients.length > 0 ?
                    d.patients.map(p => p.name).join(', ') : 'No Patients');
            ...
            $('#addDoctorForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        let errorMessage = 'Could not add doctor.';
