                    ...
                    <tr>
                        ...
                        <td class="text-start align-middle" style="padding:10px;">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                {{-- View --}}
                                @if(auth()->user()->can('view doctor'))
                                    <a href="#" class="text-dark d-flex align-items-center" title="View"
                                       data-bs-toggle="modal" data-bs-target="#viewDoctorModal-{{ $doctor->id }}">
                                ...
                                {{-- Edit --}}
                                @if(auth()->user()->can('update doctor'))
                                    <a href="#" class="text-dark d-flex align-items-center" title="Edit"
